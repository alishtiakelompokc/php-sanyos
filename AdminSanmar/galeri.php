...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
      ...
      <form action="tambah_galeri.php" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
                     <label></label>
              <div class="row">
                
                <div class="col-md-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Galeri" name="kode_galeri" id="kode_galeri">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nama Kegiatan" name="nama_kegiatan" id="nama_kegiatan">
                  </div>
                </div>
                 <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_galeri']; ?></td>
                                <td><?php echo $data['nama_kegiatan']; ?></td>
                                <td><?php echo $data['tanggal']; ?></td>
                                <td><a target="_blank" href="../img/event/<?php echo $data['foto']; ?>"><img src="../img/event/<?php echo $data['foto']; ?> " width="50px" height="50px" /></a></td>
                                <td><?php echo $data['keterangan']; ?></td>
                                <td><?php echo $data['waktu']; ?></td>
                                <td><?php echo $data['lokasi']; ?></td>
                               
                               <td> <a href='delete_galeri.php?id=<?php echo $data['kode_galeri'];?>'>Hapus</a></td>
                               <td> <a href='edit_galeri.php?kode_galeri=<?php echo $data['kode_galeri'];?>'>Edit</a></td>
