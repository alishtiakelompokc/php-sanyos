                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_komuni']; ?></td>
                                <td><?php echo $data['nama_lengkap']; ?></td>
                                <td><?php echo $data['nama_baptis']; ?></td>
                                <td><?php echo $data['tempat_lahir']; ?></td>
                                <td><?php echo $data['tanggal_lahir']; ?></td>
                                <td><?php echo $data['tempat_baptis']; ?></td>
                                <td><?php echo $data['tanggal_baptis']; ?></td>
                                <td><?php echo $data['nama_ayah']; ?></td>
                                <td><?php echo $data['nama_ibu']; ?></td>
                                <td><?php echo $data['alamat']; ?></td>
                                <td><?php echo $data['stasi']; ?></td>
                                 <td><?php
                             $kode_komuni = $data['kode_komuni'];
                             $query1 = mysqli_query($koneksi, "SELECT * FROM foto_komuni WHERE kode_komuni='$kode_komuni'");
                             ...
                             if ($row == 0) {
                                ...
                                while ($data1 = mysqli_fetch_array($query1)) {
                                    ?><a target="_blank" href="../sakramenkomuni/syarat_komuni/<?php echo $data1['foto_pendaftar']; ?>"><img src="../sakramenkomuni/syarat_komuni/<?php echo $data1['foto_pendaftar']; ?>" width="50px" height="50px" /></a><br/><?php
                                }
                             }
                             ?></td>
                                <td>
                                    ...
                                    if (isset($_GET['ubah'])) {
                                        $ubah = $_GET['ubah'];
                                        $kode = $_GET['kode'];
                                        $query = mysqli_query($koneksi, "UPDATE komuni SET status_validasi='$ubah' WHERE kode_komuni='$kode'");
                                        if ($query) {
                                            echo "<script>window.location='data_komuni.php';</script>";
                                        }
                                        else {
                                            echo "<script>alert('Data gagal diubah'); window.location='data_komuni.php';</script>";
                                        }
                                        
                                    }
                                    $status_validasi = $data['status_validasi'];
                                    if ($status_validasi == 'proses') {
                                        ?><a href="data_komuni.php?kode=<?php echo $data['kode_komuni']; ?>&ubah=diterima">Ubah Diterima</a><a href="data_komuni.php?kode=<?php echo $data['kode_komuni']; ?>&ubah=ditolak">Ubah Ditolak</a><?php
                                    }
                                    else {
