...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <!-- Header-->
                    ...
                    <form action="tambah_sakramen.php" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
                <label></label>
              <div class="row">
                
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Sakramen" name="kode_sakramen" id="kode_sakramen">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nama Sakramen" name="nama_sakramen" id="nama_sakramen">
                  </div>
                </div>
                 <div class="col-md-2">
                  <div class="form-group">
 ...
 <div class="content">
        ...
        <table class="table table-striped"> 
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM data_sakramen";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_sakramen']; ?></td>
                                <td><?php echo $data['nama_sakramen']; ?></td>
                                <td><a target="_blank" href="../img/sermons/<?php echo $data['foto']; ?>"><img src="../img/sermons/<?php echo $data['foto']; ?> " width="50px" height="50px" /></a></td>
                                <td><?php echo $data['keterangan']; ?></td>
                               
                               <td> <a href='delete_sakramen.php?id=<?php echo $data['kode_sakramen'];?>'>Hapus</a></td>
                               <td> <a href='edit_sakramen.php?kode_sakramen=<?php echo $data['kode_sakramen'];?>'>Edit</a></td>
