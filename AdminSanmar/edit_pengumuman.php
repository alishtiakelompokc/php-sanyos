	...
	?>
       <form method="post" action="proses_ubahpengumuman.php?kode_pengumuman=<?php echo $kode_pengumuman; ?>" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="form-group">
                  <input type="submit" class="btn btn-outline-success btn-block" value="Ubah">
                  <a href="pengumuman.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
