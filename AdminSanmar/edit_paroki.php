	...
	?>
       <form method="post" action="proses_ubahparoki.php?kode_jadwal=<?php echo $kode_jadwal; ?>" enctype="multipart/form-data">
              ...
              <div class="row">
				...
				<div class="form-group">
                    <input class="form-control" type="text" name="pukul" value="<?php echo $data['pukul']; ?>">
                  </div>
                
                 <div class="form-group">
                  <input type="submit" class="btn btn-outline-success btn-block" name="submit" value="Ubah">
                  <a href="misa_paroki.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
