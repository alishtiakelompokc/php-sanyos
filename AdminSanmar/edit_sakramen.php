...
<li>
                        <a href="data_kematian.php"> <i class="menu-icon fa fa-table"></i>Laporan Kematian </a>
                    </li>
              ...
              <div class="row">
                <div class="col-md-12">
                 <div class="form-group">
                    <input class="form-control" type="text" name="nama_sakramen" value="<?php echo $data['nama_sakramen']; ?>">
                  </div>
                  <div class="col-md-12">
                  <div class="form-group">
                    <input type="text" name="foto_lama" value="<?php echo $data['foto']; ?>" hidden>
					<img src="../img/sermons/<?php echo $data['foto']; ?>" width="100px" height="100px" /><br/>
					<input type="file" name="ganti_foto">
                  </div>
                  <div class="form-group">
                    <textarea class="form-control" name="keterangan" rows="8"><?php echo $data['keterangan']; ?></textarea>
                  </div>
                  <div class="form-group">
                  <input type="submit" class="btn btn-outline-success btn-block" name="submit" value="Ubah">
                  <a href="baptis.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
