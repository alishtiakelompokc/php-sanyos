...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Home</a></li>
                                    <li><a href="#">Jadwal Misa Stasi</a></li>
  ...
  <form action="tambah_misastasi.php" method="post" onSubmit="return validasi()">
                <label></label>
              <div class="row">
                
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Jadwal Misa" name="kode_stasi" id="kode_jadwal">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_stasi']; ?></td>
                                <td><?php echo $data['tempat']; ?></td>
                                <td><?php echo $data['waktu']; ?></td>
                                <td><?php echo $data['pukul']; ?></td>
                               
                               <td> <a href='delete_stasi.php?id=<?php echo $data['kode_stasi']; ?>'>Hapus</a></td>
                                 <td> <a href='edit_stasi.php?kode_stasi=<?php echo $data['kode_stasi']; ?>'>Edit</a></td>
                            </tr>
