...
$pdf->Image('../logo/bv.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Blossom Souvenir',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 085694984803',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Jl. Supriyadi No. 77 Purwokerto Timur',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'email : blossomsouvenir@gmail.com',0,'L');
