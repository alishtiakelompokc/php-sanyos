	...
	?>
      <form method="post" action="proses_ubahkontak.php?kode_kontak=<?php echo $kode_kontak; ?>" enctype="multipart/form-data">
              ...
              <div class="row">
				...
				<div class="form-group">
                    <input class="form-control" type="text" name="kontak" value="<?php echo $data['kontak']; ?>">
                  </div>
                
                 <div class="form-group">
                  <input type="submit" class="btn btn-outline-success btn-block" name="submit" value="Ubah">
                  <a href="kontak.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
