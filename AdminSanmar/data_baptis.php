 ...
 <div class="content">
        ...
        <table class="table table-striped"> 
                    <thead>
                        ...
                        <th>Agama Ibu</th>
                        <th>Pekerjaan Ibu</th>
                        <th>Tempat Sakramen Perkawinan</th>
                        <th>Status Perkawinan</th>
                        <th>Alamat Orangtua</th>
                        <th>Stasi Orangtua</th>
                        <th>Nama Wali Permandian</th>
                        <th>Tempat Permandian</th>
                        <th>Hari Permandian</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['tempat_sakramen_perkawinan'] ; ?></td>
                                <td><?php echo $data['status_perkawinan'] ; ?></td>
                                <td><?php echo $data['alamat_orangtua'] ; ?></td>
                                <td><?php echo $data['stasi_orangtua'] ; ?></td>
                                 <td><?php echo $data['nama_wali_permandian'] ; ?></td>
                                 <td><?php echo $data['tempat_permandian'] ; ?></td>
                                <td><?php echo $data['hari_permandian'] ;  ?></td>
                                    <td><?php echo $data['tanggal_permandian'] ;?></td>
                             <td><?php echo $data['pastor_yang_mempermandikan'] ; ?></td>
                             <td><?php
                             $kode_anak = $data['kode_anak'];
                             $query1 = mysqli_query($koneksi, "SELECT * FROM foto_pendaftarbaptisbayi WHERE kode_anak='$kode_anak'");
                             ...
                             if ($row == 0) {
                                ...
                                while ($data1 = mysqli_fetch_array($query1)) {
                                    ?><a target="_blank" href="../sakramenbaptis/syarat_baptis/<?php echo $data1['foto_pendaftar']; ?>"><img src="../sakramenbaptis/syarat_baptis/<?php echo $data1['foto_pendaftar']; ?>" width="50px" height="50px" /></a><br/><?php
                                }
                             }
                             ?></td>
                                <td>
                                    ...
                                    if (isset($_GET['ubah'])) {
                                        $ubah = $_GET['ubah'];
                                        $kode = $_GET['kode'];
                                        $query = mysqli_query($koneksi, "UPDATE baptis_bayi SET status_validasi='$ubah' WHERE kode_anak='$kode'");
                                        if ($query) {
                                            echo "<script>window.location='data_baptis.php';</script>";
                                        }
                                        else {
                                            echo "<script>alert('Data gagal diubah'); window.location='data_baptis.php';</script>";
                                        }
                                        
                                    }
                                    $status_validasi = $data['status_validasi'];
                                    if ($status_validasi == 'proses') {
                                        ?><a href="data_baptis.php?kode=<?php echo $data['kode_anak']; ?>&ubah=diterima">Ubah Diterima</a><a href="data_baptis.php?kode=<?php echo $data['kode_anak']; ?>&ubah=ditolak">Ubah Ditolak</a><?php
                                    }
                                    else {
