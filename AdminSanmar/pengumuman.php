                ...
                <ul class="nav navbar-nav">
                   ...
                   <li>
                        <a href="baptis.php"> <i class="menu-icon fa fa-th"></i>Sakramen </a>
                                      ...
                                      <li>
                        <a href="pengumuman.html"> <i class="menu-icon fa fa-tasks"></i>Pengumuman </a>
                    </li>
...
<li>
 ...
 <li>
    ...
    <div id="right-panel" class="right-panel">
       ...
       <form action="tambah_pengumuman.php" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Pengumuman" name="kode_pengumuman" id="kode_pengumuman">
                  </div>
                </div>
                 <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_pengumuman']; ?></td>
                               ...
                               <td> <a href='delete_pengumuman.php?id=<?php echo $data['kode_pengumuman'];?>'>Hapus</a></td>
                                 <td> <a href='edit_pengumuman.php?kode_pengumuman=<?php echo $data['kode_pengumuman'];?>'>Edit</a></td>
                            </tr>
