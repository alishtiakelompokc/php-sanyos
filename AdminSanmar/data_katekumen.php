...
<br>
 ...
 <div class="content">
    ...
    <th>Wali Permandian</th>
    <th>Pastor Yang Mempermandikan</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_katekumen']; ?></td>
                                <td><?php echo $data['nama_lengkap']; ?></td>
                                <td><?php echo $data['nama_permandian_anak']; ?></td>
                                <td><?php echo $data['tempat_lahir']; ?></td>
                                <td><?php echo $data['tanggal_lahir']; ?></td>
                                <td><?php echo $data['stasi']; ?></td>
                                <td><?php echo $data['agama_sebelumnya']; ?></td>
                                <td><?php echo $data['ijazah_terakhir']; ?></td>
                                <td><?php echo $data['pekerjaan']; ?></td>
                               
                                <td><?php echo $data['nama_anak_anak']; ?></td>
                                <td><?php echo $data['alamat_sekarang']; ?></td>
                                <td><?php echo $data['nama_suami_isteri']; ?></td>
                                <td><?php echo $data['pekerjaan_suami_isteri']; ?></td>
                                <td><?php echo $data['status_perkawinan']; ?></td>
                                <td><?php echo $data['tempat_perkawinan']; ?></td>
                                <td><?php echo $data['tanggal_perkawinan']; ?></td>
                                ...
                                <td><?php echo $data['nama_guru_agama']; ?></td>
                                 <td><?php echo $data['wali_permandian']; ?></td>
                                  <td><?php echo $data['pastor_yang_mempermandikan']; ?></td>
                                     <td><?php
                             $kode_katekumen = $data['kode_katekumen'];
                             $query1 = mysqli_query($koneksi, "SELECT * FROM foto_katekumen WHERE kode_katekumen='$kode_katekumen'");
                             ...
                             if ($row == 0) {
                                ...
                                while ($data1 = mysqli_fetch_array($query1)) {
                                    ?><a target="_blank" href="../sakramenkatekumen/syarat_katekumen/<?php echo $data1['foto_pendaftar']; ?>"><img src="../sakramenkatekumen/syarat_katekumen/<?php echo $data1['foto_pendaftar']; ?>" width="50px" height="50px" /></a><br/><?php
                                }
                             }
                             ?></td>
<td>
                                    ...
                                    if (isset($_GET['ubah'])) {
                                        $ubah = $_GET['ubah'];
                                        $kode = $_GET['kode'];
                                        $query = mysqli_query($koneksi, "UPDATE katekumen SET status_validasi='$ubah' WHERE kode_katekumen='$kode'");
                                        if ($query) {
                                            echo "<script>window.location='data_katekumen.php';</script>";
                                        }
                                        else {
                                            echo "<script>alert('Data gagal diubah'); window.location='data_katekumen.php';</script>";
                                        }
                                        
                                    }
                                    $status_validasi = $data['status_validasi'];
                                    if ($status_validasi == 'proses') {
                                        ?><a href="data_katekumen.php?kode=<?php echo $data['kode_katekumen']; ?>&ubah=diterima">Ubah Diterima</a><a href="data_katekumen.php?kode=<?php echo $data['kode_katekumen']; ?>&ubah=ditolak">Ubah Ditolak</a><?php
                                    }
                                    else {
