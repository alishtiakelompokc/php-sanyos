    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand hidden" href="./"><img src="images/logo4.jpg" alt="Logo"></a>
        ...
        <div class="content">
            <!-- Animated -->
                ...
                <!--  Traffic  -->
                        ...
                        <div class="card">
                            <div class="card-body">
                               <h4> <align="center">SISTEM INFORMASI PENDAFTARAN PENERIMAAN SAKRAMEN</align></h4>
                            <h4>PADA GEREJA KATOLIK SANTA MARIA FATIMA BREBES</h4>
                            </div>
        		...
        		<p>Kuatkanlah Hatimu,
                    <P>Jangan lemah semangatmu, karena ada upah </P>
                    <P> bagi usahamu (2 Tawarikh 15 : 17)</P>
				</p>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; Sanmar 2018
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://colorlib.com">Regina Caeli</a>
                    </div>
                </div>
            </div>
        </footer>
