...
if(!empty($_POST["baptis"])) {
	...
	if(!isset($error_message)) {
		...
		stasi_orangtua,nama_wali_permandian, tempat_permandian,hari_permandian, tgl_permandian, pastor_yang_mempermandikan) 
		VALUES 
		...
		'" . $_POST["tempat_permandian"] . "',	'" . $_POST["hari_permandian"] . "', 	'" . $_POST["tgl_permandian"] . "',	'" . $_POST["pastor_yang_mempermandikan"] . "')";
...
<html>
       <head>
		...
		<tr>
			...
			<td><input type="text" class="demoInputBox" name="nama_lengkap_anak" value="<?php if(isset($_POST['nama_lengkap_anak'])) echo $_POST['nama_lengkap_anak']; ?>"></td>
		</tr>
			<tr>
			<td>Nama Permandian Anak</td>
			<td><input type="text" class="demoInputBox" name="nama_permandian_anak" value="<?php if(isset($_POST['nama_permandian_anak'])) echo $_POST['nama_permandian_anak']; ?>"></td>
		</tr>
			<tr>
			<td>Tempat Lahir</td>
			<td><input type="text" class="demoInputBox" name="tempat_lahir" value="<?php if(isset($_POST['tempat_lahir'])) echo $_POST['tempat_lahir']; ?>"></td>
		</tr>
			<tr>
			<td>Tanggal Lahir</td>
			<td><input type="text" class="demoInputBox" name="tgl_lahir" value="<?php if(isset($_POST['tgl_lahir'])) echo $_POST['tgl_lahir']; ?>"></td>
		</tr>
			<tr>
			<td>Gender</td>
			<td><input type="radio" name="gender" value="Laki-laki" <?php if(isset($_POST['gender']) && $_POST['gender']=="Laki-laki") { ?>checked<?php  } ?>> Laki-laki
			<input type="radio" name="gender" value="Perempuan" <?php if(isset($_POST['gender']) && $_POST['gender']=="Perempuan") { ?>checked<?php  } ?>> Perempuan
			</td>
		</tr>
		    <tr>
			<td>Anak yang ke-</td>
			<td><input type="text" class="demoInputBox" name="anak_yang_ke" value="<?php if(isset($_POST['anak_yang_ke'])) echo $_POST['anak_yang_ke']; ?>"></td>
		</tr>
			<tr>
			<td>Stasi/Lingkungan</td>
			<td><input type="text" class="demoInputBox" name="stasi" value="<?php if(isset($_POST['stasi'])) echo $_POST['stasi']; ?>"></td>
		</tr>
			<tr>
			<td>Nama Ayah</td>
			...
			<td><input type="text" class="demoInputBox" name="tempat_sakramen_perkawinan" value="<?php if(isset($_POST['tempat_sakramen_perkawinan'])) echo $_POST['tempat_sakramen_perkawinan']; ?>"></td>
		</tr>
			<tr>
			...
			<td><input type="text" class="demoInputBox" name="alamat_orangtua" value="<?php if(isset($_POST['alamat_orangtua'])) echo $_POST['alamat_orangtua']; ?>"></td>
		</tr>
            <tr>
			<td>Stasi/Lingkungan Orang Tua</td>
			<td><input type="text" class="demoInputBox" name="stasi_orangtua" value="<?php if(isset($_POST['stasi_orangtua'])) echo $_POST['stasi_orangtua']; ?>"></td>
		</tr>
			<tr>
			...
			<tr>
			<td>Tempat Permandian(Stasi/Paroki)</td>
			<td><input type="text" class="demoInputBox" name="tempat_permandian" value="<?php if(isset($_POST['tempat_permandian'])) echo $_POST['tempat_permandian']; ?>"></td>
		</tr>
				<tr>
			<td>Hari Permandian</td>
			<td><input type="text" class="demoInputBox" name="hari_permandian" value="<?php if(isset($_POST['hari_permandian'])) echo $_POST['hari_permandian']; ?>"></td>
		</tr>
			<tr>
			<td>Tanggal Permandian</td>
			<td><input type="text" class="demoInputBox" name="tgl_permandian" value="<?php if(isset($_POST['tgl_permandian'])) echo $_POST['tgl_permandian']; ?>"></td>
		</tr>
			<tr>
			<td>Pastor yang mempermandikan</td>
			<td><input type="text" class="demoInputBox" name="pastor_yang_mempermandikan" value="<?php if(isset($_POST['pastor_yang_mempermandikan'])) echo $_POST['pastor_yang_mempermandikan']; ?>"></td>
		</tr>
		    <tr>
            <td colspan=2>
            <input type="checkbox" name="terms"> I accept Terms and Conditions <input type="submit" name="baptis" value="Register" class="btnRegister"></td>
            </tr>
