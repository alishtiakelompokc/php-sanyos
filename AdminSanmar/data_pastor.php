...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <!-- Header-->
                    ...
                    <form action="tambah_pastor.php" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
                <label></label>
              <div class="row">
                
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Pastor" name="kode_pastor" id="kode_pastor">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Nama Pastor" name="nama_pastor" id="nama_pastor">
                  </div>
                </div>
                 <div class="col-md-2">
                  <div class="form-group">
                   <select name ="jabatan"  class="form-control"><option value="Pastor Paroki">Jabatan</option><option value="Pastor Stasi">Pastor Paroki</option><option value="Pastor Stasi">Pastor Pembantu</option></select>
                   </div>
                </div>
                 <div class="col-md-2">
                  <div class="form-group">
                    <input type="file" name="foto" class="form-control" required="">
                     <div class="col-md-2">
                    <h6>Ukuran gambar maks.2500kb</h6>
                    </div>
                  </div>
                </div>
                 <div class="col-md-6">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_pastor']; ?></td>
                                <td><?php echo $data['nama_pastor']; ?></td>
                                <td><?php echo $data['jabatan']; ?></td>
                                <td><a target="_blank" href="../img/pastors/<?php echo $data['foto']; ?>"><img src="../img/pastors/<?php echo $data['foto']; ?> " width="50px" height="50px" /></a></td>
                                <td><?php echo $data['keterangan']; ?></td>
                               
                               <td> <a href='delete_pastor.php?id=<?php echo $data['kode_pastor'];?>'>Hapus</a></td>
                               <td> <a href='edit_pastor.php?kode_pastor=<?php echo $data['kode_pastor'];?>'>Edit</a></td>
