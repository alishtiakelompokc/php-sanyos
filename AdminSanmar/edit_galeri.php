              ...
              <div class="row">
                <div class="col-md-12">
                 <div class="form-group">
                    <input class="form-control" type="text" name="nama_kegiatan" value="<?php echo $data['nama_kegiatan']; ?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <input class="form-control" type="text" name="waktu" value="<?php echo $data['waktu']; ?>">
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <a href="galeri.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
