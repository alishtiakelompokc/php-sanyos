 ...
 <div class="content">
        ...
        <table class="table table-striped"> 
                    ...
                    <tbody>
                        ...
                        $query = "SELECT * FROM pindahan_kristenkatolik";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $data['kode_pindahan']; ?></td>
                                ...
                                <td><?php echo $data['tgl_perkawinan']; ?></td>
                                ...
                                <td><?php
                             $kode_pindahan = $data['kode_pindahan'];
                             $query1 = mysqli_query($koneksi, "SELECT * FROM foto_pindahan WHERE kode_pindahan='$kode_pindahan'");
                             ...
                             if ($row == 0) {
                                ...
                                while ($data1 = mysqli_fetch_array($query1)) {
                                    ?><a target="_blank" href="../sakramenkristenkatolik/syarat_pindahan/<?php echo $data1['foto_pendaftar']; ?>"><img src="../sakramenkristenkatolik/syarat_pindahan/<?php echo $data1['foto_pendaftar']; ?>" width="50px" height="50px" /></a><br/><?php
                                }
                             }
                             ?></td>
                                <td>
                                    ...
                                    if (isset($_GET['ubah'])) {
                                        $ubah = $_GET['ubah'];
                                        $kode = $_GET['kode'];
                                        $query = mysqli_query($koneksi, "UPDATE pindahan_kristenkatolik SET status_validasi='$ubah' WHERE kode_pindahan='$kode'");
                                        if ($query) {
                                            echo "<script>window.location='data_pindahan.php';</script>";
                                        }
                                        else {
                                            echo "<script>alert('Data gagal diubah'); window.location='data_pindahan.php';</script>";
                                        }
                                        
                                    }
                                    $status_validasi = $data['status_validasi'];
                                    if ($status_validasi == 'proses') {
                                        ?><a href="data_pindahan.php?kode=<?php echo $data['kode_pindahan']; ?>&ubah=diterima">Ubah Diterima</a><a href="data_pindahan.php?kode=<?php echo $data['kode_pindahan']; ?>&ubah=ditolak">Ubah Ditolak</a><?php
                                    }
                                    else {
