...
<div class="row">
  ...
  <td>
   ...
   <td>
       <h3 align="center"><span class='label'>Formulir Pendaftaran Sakramen Baptis</span></h3><br/>
   </td> 
...
$connect = mysqli_connect($host, $username, $password, $database); // Koneksi ke MySQL
    ...
    $query = "select nama_lengkap,nama_permandian_anak,tempat_lahir,tanggal_lahir,jenis_kelamin,anak_yang_ke,
stasi,no_hp,
...
nama_wali_permandian, tempat_permandian, hari_permandian,tanggal_permandian,pastor_yang_mempermandikan,kode_anak,tgl_daftar from baptis_bayi order by kode_anak desc limit 1"; // Query untuk menampilkan semua data siswa
