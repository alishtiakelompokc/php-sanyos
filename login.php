...
if ($password != $password1) {
	echo "<script>alert('Password dan Repeat Password tidak sama'); window.location='login.php?register=ok';</script>";
}
else{
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="password1" placeholder="Repeat Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" name="submitregister">
							Register
						</button>
					</div>
				</form>
...
$runquery1 = mysqli_query($koneksi, "SELECT * FROM user WHERE username = '$username1' AND password = '$password1'");
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="" method="POST">
					...
					<div class="text-center p-t-136">
						<a class="txt2" href="login.php?register=ok">
							Buat Akun
