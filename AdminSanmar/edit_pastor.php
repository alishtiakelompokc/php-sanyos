              ...
              <div class="row">
                <div class="col-md-12">
                 <div class="form-group">
                    <input class="form-control" type="text" name="nama_pastor" value="<?php echo $data['nama_pastor']; ?>">
                  </div>
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <a href="data_pastor.php"><input type="button"class="btn btn-outline-success btn-block" value="Batal"></a>
                </div>
                </div>
