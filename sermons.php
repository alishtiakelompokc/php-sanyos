...
<body>
	...
	<header class="header-section">
		<div class="container">		
			<!-- logo -->
			<a href="index.php" class="site-logo"><img src="img/santo%20yosep.png" alt=""></a>
	...
	<section class="sermons-list-section spad">
		<div class="container">
			<div class="section-title">
				...
				<h2>Sebelum anda mendaftar, pastikan anda sudah benar-benar paham dengan Sakramen Gereja Katolik</h2>
			</div>
			...
			<div class="el-item">
				 <?php
					include 'koneksi.php';
					$query = mysqli_query($koneksi, "SELECT * FROM data_sakramen");
					while ($data = mysqli_fetch_array($query)) {
					?>
					<div class="row">
				<div class="col-sm-6 col-md-4">
					
						<div class="el-thubm set-bg" data-setbg="img/sermons/<?php echo $data['foto']; ?>"></div>
                        </div>
                        <div class="col-md-8" align="justify">
							<div class="el-content">
								<div class="el-header">
                                    
							<h4><?php echo $data['nama_sakramen']; ?></h4>
                        </div>
                        <div></div>
