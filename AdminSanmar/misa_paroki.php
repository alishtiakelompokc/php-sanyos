...
<body>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="#">Home</a></li>
                                    <li><a href="#">Jadwal Misa Paroki</a></li>
  ...
  <form action="tambah_jadmisa.php" method="post" onSubmit="return validasi()">
                <label></label>
              <div class="row">
                
                <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Kode Jadwal Misa" name="kode_jadwal" id="kode_jadwal">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                   <select name ="tempat" class="form-control"><option value="Tempat">Tempat</option><option value="Gereja Katolik Santa Maria Fatima Brebes">Gereja Katolik Santa Maria Fatima Brebes</option></select>
                </div>
                </div>
                <div class="col-md-2">
                  <div class="form-group">
                 ...
                 <div class="col-md-2">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Pukul" name="pukul" id="pukul">
                  </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                               ...
                               <td> <a href='delete_jadmisa.php?id=<?php echo $data['kode_jadwal'];?>'>Hapus</a></td>
                                <td> <a href='edit_paroki.php?kode_jadwal=<?php echo $data['kode_jadwal'];?>'>Edit</a></td>
